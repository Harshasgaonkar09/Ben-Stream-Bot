    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  **Contact Developer [Sᴄᴏᴏʙʏ](https://telegram.me/Scooby_Men) he will help you.**",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Sᴄᴏᴏʙʏ](https://telegram.me/Scooby_Men)**",
...
<b>❇️  ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : @theottservice</b>"""
        ...
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton('🎪  Uᴘᴅᴀᴛᴇ  🎪', url='https://t.me/theottservice')]])
        )
